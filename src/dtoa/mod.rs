...
// C++ implementation dtoa.h by https://github.com/dtolnay
//
// The only modification made was to remove tailing `.0` on values
// that are complete integers.
...
use dtoa::diyfp::DiyFp;

#[inline]
pub fn write<W: io::Write>(wr: &mut W, value: f64) -> io::Result<()> {
    unsafe { dtoa(wr, value) }
}
