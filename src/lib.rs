...
pub mod iterators {
    ...
    pub type Entries<'a> = super::object::Iter<'a, beef::lean::Cow<'a, str>, super::JsonValue<'a>>;

    /// Mutable iterator over key value pairs of `JsonValue::Object`.
    pub type EntriesMut<'a> = super::object::IterMut<'a, beef::lean::Cow<'a, str>, super::JsonValue<'a>>;
}
